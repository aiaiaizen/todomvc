...
test.describe('Custom Chrome Path', () => {
  test('should allow a user to add three tasks, modify them, mark them as complete, modify them again, mark them as complete again, and clear all completed tasks', async () => {
